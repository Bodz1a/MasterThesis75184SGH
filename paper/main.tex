...
\begin{itemize}[noitemsep]
	\item \textbf{E1 (Single firm: price sensitivity)}: Varying $\alpha$ while holding other parameters fixed, to quantify how pricing power changes with consumer price sensitivity.
