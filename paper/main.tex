...
The breadth and analytical power of the agent-based approach in analyzing abstract subjects is reflected in examples of its application in studies of racial segregation (Schelling, 1978), the life cycle of firms \parencite{axtell2006}, stock market dynamics (\cite{sbe2018}), cultural convergence (\cite{axelrod1997}) or electoral procedures (\cite{hsm2019}).
